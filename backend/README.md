...
- Sample: `curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{ "question": "Who won the FIFA 2018 World Cup?", "answer": "France", "difficulty": 3, "category": "6" }'`
...
```json
{
  ...
  "questions": [
    ...
    },
    {
      ...
      "difficulty": 3,
      "id": 28,
      "question": "Who won the FIFA 2018 World Cup?"
    }
  ],
  "success": true,
  "total_questions": 2
...
- Ahmad Alsobhi on the API and test suite to integrate with the frontend
