...
def create_app(test_config=None):
  ...
  """
    ...
    def retrieve_categories():
        ...
        formate_categories = [category.format() for category in categories]
    ...
    def retrieve_categories_about_get():
        categories = Category.query.order_by(Category.id).all()
        formate_categories = [category.format() for category in categories]
    ...
    def create_question():
        ...
        try:
            ...
            return jsonify(
                {
                    "success": True,
                    "create question id": question.id,
                    "quesrions": current_questions,
                    "total_question": len(Question.query.all()),
                }
            )
